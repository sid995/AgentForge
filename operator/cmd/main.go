...
func main() {
	...
	// When an explicit certificate is absent, controller-runtime creates an
	// ephemeral self-signed certificate. Production overlays must provide a
	// trusted certificate through these flags.
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e666c13d.agentforge.dev",
