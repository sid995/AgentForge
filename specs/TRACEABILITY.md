...
| FR-SCH-003 Select clusters and reserve capacity | `04-services/02-scheduler.md`, `06-data/01-relational-schema.md`, ADR-003 | registry and deterministic strategies in `internal/domain/cluster.go`, `internal/adapters/postgres/clusters.go`, `internal/application/scheduler/strategy.go`, migration `000007`; reservations pending | registry integration plus deterministic tie, capacity, and region-fallback tests; reservation tests pending | Implemented |
