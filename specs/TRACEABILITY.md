...
| FR-SCH-004 Emit atomic scheduling intent | `03-domain/02-state-machines.md`, `07-events/02-topic-catalog.md`, ADR-002, ADR-003 | `internal/adapters/postgres/scheduling_intent.go`, versioned event contracts, migration `000009`; process wiring pending | competing exact-replay, rollback, assignment/reservation/outbox, and capacity-wait integration tests | Implemented |
