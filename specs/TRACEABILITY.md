...
| FR-SCH-003 Select clusters and reserve capacity | `04-services/02-scheduler.md`, `06-data/01-relational-schema.md`, ADR-003 | registry in `internal/domain/cluster.go`, `internal/adapters/postgres/clusters.go`, migration `000007`; strategies/reservations pending | registry validation/freshness/allowlist/version tests; selection and reservation tests pending | Implemented |
