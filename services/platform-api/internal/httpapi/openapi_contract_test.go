...
func TestOpenAPIContractDocumentsImplementedRunRoutes(t *testing.T) {
	...
	for _, path := range []string{"/v1/projects/{projectId}/runs", "/v1/runs/{runId}", "/v1/runs/{runId}/cancel", "/v1/runs/{runId}/retry", "/v1/runs/{runId}/artifacts", "/v1/runs/{runId}/artifacts/{artifactId}", "/v1/runs/{runId}/artifacts/{artifactId}/download"} {
